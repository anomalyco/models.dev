...
- The API is authoritative for display names, temperature metadata, and the `thinking` flag when present. Token limits normally come from the API, except two Gemini 3.1 Flash Image variants whose model-specific cards document different limits.
