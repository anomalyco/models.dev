export const ALL_COLUMN_IDS = [
  "provider", "model", "family", "provider-id", "model-id",
  "tool-call", "reasoning", "input-modalities", "output-modalities",
  "input-cost", "output-cost", "reasoning-cost", "cache-read-cost",
  "cache-write-cost", "audio-input-cost", "audio-output-cost",
  "context-limit", "input-limit", "output-limit",
  "structured-output", "temperature", "weights",
