...
function resolveBaseModel(apiModelID: string): string | undefined {
  ...
  const overrides: Record<string, string> = {
    ...
    "mistralai/codestral-2508": "mistral/codestral-latest",
    "mistralai/mistral-large-2407": "mistral/mistral-large-2512",
    "mistralai/mistral-small-24b-instruct-2501": "mistral/mistral-small-2506",
    "mistralai/mistral-large": "mistral/mistral-large-latest",
    "mistralai/mistral-medium-3": "mistral/mistral-medium-2505",
    "mistralai/mistral-medium-3-5": "mistral/mistral-medium-2508",
    "mistralai/ministral-3b-2512": "mistral/ministral-3b-latest",
    "mistralai/ministral-8b-2512": "mistral/ministral-8b-latest",
    "mistralai/ministral-14b-2512": "mistral/ministral-8b-latest",
    "mistralai/mixtral-8x22b-instruct": "mistral/open-mixtral-8x22b",
  };
