...
import { alibabaCn } from "./providers/alibaba-cn.js";
...
export const groups = {
  ...
  direct: ["alibaba", "alibaba-cn", "alibaba-global", "baseten", "google", "ovhcloud", "venice", "xai"],
} as const;
