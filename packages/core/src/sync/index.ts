...
import { airforce } from "./providers/airforce.js";
...
export const groups = {
  aggregators: ["airforce", "crossmodel", "empiriolabs", "huggingface", "kilo", "llmgateway", "openrouter", "vercel"],
