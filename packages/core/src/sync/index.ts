...
export const providers: {
  ...
  "cloudflare-ai-gateway-workers-ai": SyncProvider<any>;
  ...
  baseten,
  chutes,
  "cloudflare-ai-gateway-workers-ai": cloudflareAiGatewayWorkersAi,
...
export const groups = {
  ...
  cloudflare: ["cloudflare-workers-ai", "cloudflare-ai-gateway-workers-ai"],
