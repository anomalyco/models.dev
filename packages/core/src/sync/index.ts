...
import { runinfra } from "./providers/runinfra.js";
...
export const groups = {
  ...
  direct: ["ambient", "anthropic", "baseten", "chutes", "cortecs", "deepinfra", "digitalocean", "google", "hyper", "openai", "ovhcloud", "pioneer", "runinfra", "tinfoil", "venice", "wandb", "xai"],
} as const;
